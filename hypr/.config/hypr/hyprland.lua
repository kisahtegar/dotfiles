...
--local terminal    = "wezterm-launch"
--local terminal    = "env WAYLAND_DISPLAY= wezterm-gui"
...
-- screenshot binds
hl.bind("PRINT", hl.dsp.submap("󰹑"))

hl.define_submap("󰹑", function()
	-- selected region -> clipboard
	hl.bind("A", hl.dsp.exec_cmd("hyprshot -m region --clipboard-only"))

	-- selected region -> save file
	hl.bind("S", hl.dsp.exec_cmd("hyprshot -m region -o ~/Pictures/Screenshots"))

	-- focused monitor -> clipboard
	hl.bind("O", hl.dsp.exec_cmd("hyprshot -m output --clipboard-only"))
